...
public class History {
    ...
    public int getProgressionSecondes() { return progressionSecondes; }
    public void setProgressionSecondes(int progressionSecondes) { this.progressionSecondes = progressionSecondes; }
